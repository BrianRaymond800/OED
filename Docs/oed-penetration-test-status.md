...
| 7 | Known Vulnerabilities in Software Components | Medium | Design docs | — | ⚠️ Design Only | Oye, Andrew | Documented but not implemented |
...
| 17 | Session Tokens Stored in Local Storage | Low | #83, #115 | — | 🔴 Not Started | — | Tokens still stored in local storage |
| 18 | Incorrect HTTP Response Codes | Minimal | #84, #116 | — | 🔴 Not Started | — | Response handling not implemented |
| 19 | Business Logic Issues | Minimal | #85, #117 | — | 🔴 Not Started | — | Logic fixes not started |
